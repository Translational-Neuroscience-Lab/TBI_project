...
matlab -nosplash -nodesktop -r "addpath('/home/eshams/scratch/test'); base_path = '/home/eshams/scratch/test/Dataset/NLF/NLF_Older_Cohort'; mse_pls_group_session_interactions(base_path); exit;"
